...
class ChildViewController: UIViewController, IndicatorInfoProvider, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        //SwiftSpinner.show("Loading \(childNumber) Page...")
        ...
        SwiftSpinner.show("Loading \(childNumber) Headlines...")
        
        //For fetching changes from Bookmarks Page
        NotificationCenter.default.addObserver(self, selector: #selector(loadHeadlinesPage), name: NSNotification.Name(rawValue: "reloadHeadlinesPage"), object: nil)
    }
    ...
    @objc func loadHeadlinesPage(notification: NSNotification){
        //load data here
        fetchArticles()
    ...
    */
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "articleCellNew", for: indexPath) as! ArticleCellNew
